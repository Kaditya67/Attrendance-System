    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('department', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='courses', to='myapp.department', verbose_name='Department')),
            ],
        ),
        migrations.CreateModel(
            name='Program',
        ...
        migrations.AddField(
            model_name='program',
            name='year',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='programs', to='myapp.year', verbose_name='Year'),
        ),
        migrations.AddField(
            model_name='course',
            name='year',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='courses', to='myapp.year', verbose_name='Year'),
        ),
        migrations.CreateModel(
            name='HOD',
            fields=[
                ...
                ('department', models.OneToOneField(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='myapp.department', verbose_name='Department')),
                ('user', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
            ],
            options={
                'indexes': [models.Index(fields=['department'], name='myapp_hod_departm_7ce51f_idx')],
                'constraints': [models.UniqueConstraint(fields=('department',), name='unique_hod_per_department')],
            },
        ),
        migrations.CreateModel(
            name='Principal',
